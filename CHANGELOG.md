...
- A reconnect now fails any discovery, apply, or restore action still awaiting its LCD receipt, so replacement-session evidence cannot complete or contaminate the prior write.
